...
inline bool Bounds3::IntersectP(const Ray& ray) const
{
    ...
    // don't need invDir and dirIsNeg to implement this argument
    // this function simply calls the overloading function and 
    // I do not get what hitt0 and hitt1 are for.
    float h0=0.0,h1=0.0;
    return IntersectP(
        ray,&h0,&h1
    );
